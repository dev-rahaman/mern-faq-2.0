...
const CartContainer = () => {
  return (
    <div>
      <div className="p-1 rounded-lg shadow-inherit border dark:bg-[#1c2b4b] my-20 lg:mx-3 mx-12">
            ...
            <Cart
              svgIcon={
                <svg
                  ...
                  stroke-width="0"
                  viewBox="0 0 16 16"
                  class="text-colorful text-[#6d28d9] dark:text-[#38bdf8]"
                  height="48"
                  width="48"
              ...
              cartTitle={"12 টি মডিউলে 135+ ভিডিও"}
              cartParagraph={
                "আপনারা যেন ধাপে ধাপে শিখতে পারেন সেজন্য পুরো কোর্সটি 12টি মডিউলে ও 135+ ভিডিওতে ভাগ করে সাজানো হয়েছে।"
              }
            ></Cart>
